...
class LandingController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $thumbnail_gedi = ThumbnailService::where('service_id', $id)->first();

        return view('pages.landing.detail', compact('service', 'thumbnail', 'advantage_user', 'advantage_service', 'tagline', 'thumbnail_gedi'));
    }
