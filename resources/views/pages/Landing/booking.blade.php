    ...
    <section class="w-auto flex min-h-[85vh] pt-6 pb-20 mx-auto lg:mx-12 px-4">
        <div class="m-auto text-center h-auto">
            ...
            <svg class="mb-6 w-full" width="490" height="350" viewBox="0 0 490 350" fill="none"
                ...
                <circle r="6.5" transform="matrix(1 0 0 -1 368.5 52.5)" fill="#3E66FB"/>
                <circle r="6.5" transform="matrix(1 0 0 -1 113.5 58.5)" fill="#3E66FB"/>
                <circle r="6.5" transform="matrix(1 0 0 -1 296.5 291.5)" fill="#3E66FB"/>
                <line x1="116" y1="175" x2="374" y2="175" stroke="#3E66FB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="12 12"/>
                <circle cx="245" cy="175" r="30" fill="#3E66FB"/>
